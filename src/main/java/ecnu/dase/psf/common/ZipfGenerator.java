...
public class ZipfGenerator {
     ...
     */
    public ZipfGenerator(int _items) {
        this(0, _items - 1);
    }
     ...
     */
    public ZipfGenerator(int _min, int _max) {
     ...
     */
    public ZipfGenerator(int min, int max, double _zipfianconstant) {
     ...
     */
    public ZipfGenerator(int min, int max, double _zipfianconstant, double _zetan) {
        ...
        zetan = _zetan;
        countforzeta = size;
        eta = (1 - Math.pow(2.0 / size, 1 - theta)) / (1 - zeta2theta / zetan);
     ...
     * @param initialsum The value of zeta we are computing incrementally from.
     */
    static double zetastatic(int st, int n, double theta, double initialsum) {
     ...
     * @return The next item in the sequence.
     */
    public long nextLong(int itemcount) {
